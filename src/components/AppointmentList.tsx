      ...
      {appointments.map(appointment => (
        ...
        >
          <div className="grid grid-cols-2 gap-2">
            ...
            <p><span className="font-medium">Date:</span> {formatDate(appointment.appointment_time)}</p>
            <p><span className="font-medium">Time:</span> {formatTime(appointment.appointment_time)}</p>
          </div>
          {appointment.notes && (
            <p className="mt-2">
